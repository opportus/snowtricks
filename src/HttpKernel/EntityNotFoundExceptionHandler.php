...
/**
 * The entity not found exception handler.
 *
 * @version 0.0.1
 ...
 */
class EntityNotFoundExceptionHandler implements ExceptionHandlerInterface
{
    /**
    ...
    public function handle(Request $request) : Response
    {
        ...
        $subRequest->attributes->set('_controller', ExceptionController::class.'::getEntityNotFoundException');
